...
using KingdomGarden.API.Models;
using KingdomGarden.API.Providers;
using KingdomGarden.API.Results;
using KingdomGarden.API.Models.Kingdom_Garden;
using KingdomGarden.API.Controllers.Kingdom__Garden;

namespace KingdomGarden.API.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var resultProfile = new ProfileController();
            resultProfile.Post(profile);
